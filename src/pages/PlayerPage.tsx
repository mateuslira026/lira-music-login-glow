...
const PlayerPage = () => {
  ...
  console.log('PlayerPage render - currentSong:', currentSong, 'isPlaying:', isPlaying);
  ...
  // Sempre renderizar a página, mesmo sem música
      ...
      <div className="flex items-center justify-between mb-6 sm:mb-8">
        ...
        <div className="text-center">
          <p className="text-xs uppercase">
            {currentSong ? 'Tocando do Álbum' : 'Player'}
          </p>
          <p className="text-sm font-semibold truncate">
            {currentSong ? (currentSong.albumTitle || currentSong.title) : 'Nenhuma música selecionada'}
          </p>
        </div>
      ...
      {!currentSong ? (
        ...
        <div className="flex-grow flex flex-col items-center justify-center">
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl font-semibold mb-2">Nenhuma música selecionada</h2>
            <p className="text-gray-400">Escolha uma música para começar a tocar</p>
          </div>
          <Button onClick={() => navigate('/home')} className="bg-white text-black hover:bg-gray-200">
            Voltar para Home
          </Button>
        </div>
      ) : (
            ...
            <div className="mb-4 sm:mb-6 px-2">
              ...
              {audioError && (
                <div className="text-sm text-red-400 mt-2">
                  <p>Erro no áudio: {audioError}</p>
                  <p className="text-xs text-gray-500">Usando áudio livre de direitos autorais</p>
                </div>
              )}
            </div>
